const API = 'https://youtube-v31.p.rapidapi.com/search?channelId=UCqe6_gCDnh3LLsxVHAlL2VA&part=snippet%2Cid&order=date&maxResults=10';
const content = null || document.getElementById('content');
const options = {
	method: 'GET',
	headers: {
		'X-RapidAPI-Key': '7470d663eamsh6a5bec66f205337p1de737jsn18a12246149c',
